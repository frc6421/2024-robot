...
public class BlueAmpThreePieceCommand extends SequentialCommandGroup {
  ...
  public BlueAmpThreePieceCommand(DriveSubsystem drive, IntakeSubsystem intake, TransitionSubsystem transition, ShooterSubsystem shooter, ShooterAngleSubsystem shooterAngle, TransitionArmSubsystem armSubsystem) {
    ...
    addCommands(
     ...
     // pickup second note
      new ParallelDeadlineGroup(new WaitCommand(2.5), driveToFirstNoteCommand, new SequentialCommandGroup(new WaitCommand(AutoConstants.AUTO_INTAKE_DELAY), new IntakeTransitionCommand(transitionSubsystem, intakeSubsystem))), 
      driveToScoreNote1Command,
    ...
    new ParallelCommandGroup(new InstantCommand(() -> shooterSubsystem.stopShooterMotor()), 
      ...
      // pickup third note
    new ParallelDeadlineGroup(driveToSecondNoteCommand, new SequentialCommandGroup(new WaitCommand(AutoConstants.AUTO_INTAKE_DELAY), new IntakeTransitionCommand(transitionSubsystem, intakeSubsystem))),
      driveToScoreNote2Command,
