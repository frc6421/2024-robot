...
public class TuneShooter extends Command {
  ...
  public void execute() {
    ...
    //Updating the bottom shooter tuning values
    bottomkP = bottomkPWidget.getEntry().getDouble(shooterSubsystem.bottomShooterConfig.Slot0.kP);
    bottomkS = bottomkSWidget.getEntry().getDouble(shooterSubsystem.bottomShooterConfig.Slot0.kS);
    bottomkV = bottomkVWidget.getEntry().getDouble(shooterSubsystem.bottomShooterConfig.Slot0.kV);
    shooterSubsystem.setBottomConfig(bottomkP,bottomkS,bottomkV);
  }
